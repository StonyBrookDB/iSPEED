...
queryprocessor_3d -q spjoin -a /user/teng/test1/input1 -b /user/teng/test1/input2 -h /user/teng/test1/output -u fg_3d --spatialproc --binpath ~/project/iSPEED/build/bin/
